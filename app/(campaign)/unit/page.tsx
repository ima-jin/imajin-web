      ...
      <section className="py-20 md:py-32">
        <Container>
          ...
          <div className="text-center mb-20">
            <Heading level={2} className="text-gray-100 text-2xl md:text-3xl font-normal max-w-3xl mx-auto leading-relaxed font-[family-name:var(--font-space-grotesk)]">
          ...
          <div className="max-w-3xl mx-auto space-y-12">
            {/* Section 1 */}
            <div>
              <Heading level={3} className="text-gray-100 text-lg md:text-xl font-medium mb-3 tracking-wide font-[family-name:var(--font-space-grotesk)]">
                OUR BUILDING MATERIAL? LIGHT ITSELF
              </Heading>
              <Text className="text-gray-400 text-base md:text-lg leading-relaxed font-[family-name:var(--font-space-grotesk)]">
